...
def chage(text="Type",src="English",dest="Hindi"):
    text1=text
    src1=src
    dest1=dest
    trans= Translator()
...
def data():
    ...
    textget=chage(text=msg,src=s,dest=d)
...
lab_text=Label(root,text="Soruce Text",font=("Time New Roman",20,"bold"),fg="Black",bg="Red")
...
lab_text=Label(root,text="Destination Text",font=("Time New Roman",20,"bold"),fg="Black",bg="Red")
